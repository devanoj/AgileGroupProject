...
public class agileGroupProject extends JFrame implements ActionListener{
			...
			button.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						// TODO Auto-generated method stub
							...
							agileGroupProject window = new agileGroupProject("Supevalu");
							window.pack();
	...
	public agileGroupProject(String title) {
		super(title);
		...
		create.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
					frame.setVisible(false);
					agileGroupProject.this.setVisible(false);
		...
		createItem.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				StockDialog dialog = new StockDialog(agileGroupProject.this,"New Employee", true);
